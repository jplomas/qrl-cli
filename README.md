...
@theqrl/cli/1.11.3 linux-x64 node-v24.20.0
...
* [`qrl-cli config [ACTION] [KEY] [VALUE]`](#qrl-cli-config-action-key-value)
* [`qrl-cli create-wallet`](#qrl-cli-create-wallet)
* [`qrl-cli dump-transactions ADDRESS`](#qrl-cli-dump-transactions-address)
...
* [`qrl-cli list-transactions [ADDRESS]`](#qrl-cli-list-transactions-address)
...
* [`qrl-cli token:create`](#qrl-cli-tokencreate)
* [`qrl-cli token:transfer`](#qrl-cli-tokentransfer)
...
_See code: [src/commands/balance.js](https://github.com/theqrl/qrl-cli/blob/v1.11.3/src/commands/balance.js)_
...
_See code: [src/commands/config.js](https://github.com/theqrl/qrl-cli/blob/v1.11.3/src/commands/config.js)_
...
_See code: [src/commands/create-wallet.js](https://github.com/theqrl/qrl-cli/blob/v1.11.3/src/commands/create-wallet.js)_

## `qrl-cli dump-transactions ADDRESS`

Dump transaction list for a QRL address to console and optionally to CSV file
...
ARGUMENTS
  ADDRESS  QRL address or wallet.json file to dump transactions for
...
_See code: [src/commands/dump-transactions.js](https://github.com/theqrl/qrl-cli/blob/v1.11.3/src/commands/dump-transactions.js)_
...
OPTIONS
  ...
  -f, --fee=fee                            (default: 0) QRL (f)ee for transaction in Shor
  -g, --grpc=grpc                          Custom grcp endpoint to connect a hosted QRL node (-g 127.0.0.1:19009)
...
_See code: [src/commands/generate-lattice-keys.js](https://github.com/theqrl/qrl-cli/blob/v1.11.3/src/commands/generate-lattice-keys.js)_
...
_See code: [src/commands/generate-shared-keys.js](https://github.com/theqrl/qrl-cli/blob/v1.11.3/src/commands/generate-shared-keys.js)_
...
_See code: [src/commands/get-keys.js](https://github.com/theqrl/qrl-cli/blob/v1.11.3/src/commands/get-keys.js)_
...
_See code: [src/commands/list-transactions.js](https://github.com/theqrl/qrl-cli/blob/v1.11.3/src/commands/list-transactions.js)_
...
_See code: [src/commands/notarize.js](https://github.com/theqrl/qrl-cli/blob/v1.11.3/src/commands/notarize.js)_
...
_See code: [src/commands/ots.js](https://github.com/theqrl/qrl-cli/blob/v1.11.3/src/commands/ots.js)_
...
_See code: [src/commands/receive.js](https://github.com/theqrl/qrl-cli/blob/v1.11.3/src/commands/receive.js)_
...
_See code: [src/commands/search.js](https://github.com/theqrl/qrl-cli/blob/v1.11.3/src/commands/search.js)_
...
OPTIONS
  ...
  -f, --fee=fee                    Fee for transaction in Shor (defaults to 0 Shor)
  -g, --grpc=grpc                  Advanced: grpc endpoint (for devnet/custom QRL network deployments)
...
_See code: [src/commands/send.js](https://github.com/theqrl/qrl-cli/blob/v1.11.3/src/commands/send.js)_
...
_See code: [src/commands/send-message.js](https://github.com/theqrl/qrl-cli/blob/v1.11.3/src/commands/send-message.js)_
...
_See code: [src/commands/sign-tx-offline.js](https://github.com/theqrl/qrl-cli/blob/v1.11.3/src/commands/sign-tx-offline.js)_
...
_See code: [src/commands/status.js](https://github.com/theqrl/qrl-cli/blob/v1.11.3/src/commands/status.js)_
...
_See code: [src/commands/token/create.js](https://github.com/theqrl/qrl-cli/blob/v1.11.3/src/commands/token/create.js)_
...
_See code: [src/commands/token/transfer.js](https://github.com/theqrl/qrl-cli/blob/v1.11.3/src/commands/token/transfer.js)_
...
_See code: [src/commands/validate.js](https://github.com/theqrl/qrl-cli/blob/v1.11.3/src/commands/validate.js)_
<!-- commandsstop -->
